#!/bin/bash
# Nocostcoin Devnet Launcher (Linux/macOS)
# Launches a 3-node devnet in separate terminal windows

echo "=== Nocostcoin Devnet Launcher ==="
echo ""
...
echo ""
echo "To stop the devnet: Close all node windows or press Ctrl+C in each"
echo ""
